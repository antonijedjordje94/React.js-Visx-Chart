...
function App() {
  ...
  return (
    <div css={appCss}>
      <header css={appHeader}>Djordje - React VisX chart</header>
      <nav css={appNav}>
        {CHARTS.map(({ name, key }) => (
          <a
        ...
        <hr />
        <div>
          <a css={linkStyle} href="https://github.com/antonijedjordje94/React.js-Visx-Chart">
            (repo)
          </a>
        </div>
        <div>Djordje - React charts example</div>
      </nav>
